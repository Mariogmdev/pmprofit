...
import { ChevronDown, ChevronRight, Package, Building2, Receipt } from 'lucide-react';
...
export default function ConstructorTab() {
  ...
  return (
    <div className="p-6 space-y-4 max-w-7xl mx-auto">
      ...
      {/* Section B: Spaces and Infrastructure (Placeholder) */}
      <Collapsible open={sectionBOpen} onOpenChange={setSectionBOpen}>
          ...
          <CollapsibleTrigger asChild>
            <CardHeader className="cursor-pointer hover:bg-muted/50 transition-colors">
              <CardTitle className="flex items-center gap-3">
                ...
                <span className="flex-1">Sección B: Espacios e Infraestructura</span>
